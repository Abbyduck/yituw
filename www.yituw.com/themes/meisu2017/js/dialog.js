...
$(function(){
	...
	$('#xj').click(function(){
		...
		loading(1);
		$.post("http://www.yituw.com/themes/meisu2017/js/user_api_collection.php?act=add",
			{
				title:class_title
			},
		    function(data){
		 ...
		 title: '选择授权用户',
		  ...
		  yes: function(index){
			...
			if(a_id==0 && new_name==''){
				...
				loading(1);
				$.post("http://www.yituw.com/themes/meisu2017/js/user.php?act=ajax_pdf",
					{
...
//注册地方点击登录
	...
	$('#auth').click(function(){
		...
		loading(1);
		$.post("http://www.yituw.com/themes/meisu2017/js/user.php?act=authorized_add",
			{
